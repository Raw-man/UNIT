...
void App::SetUpSubcmdExport() {
  ...
  sub->add_option("-b,--base,base", exp_opt.base_path,
                  "An optional input path to a game asset to use for "
  ...
  asset_group
      ->add_flag("--visibility,!--no-visibility", exp_opt.visibility,
                 "Join meshes by their respective groups and export mesh group "
